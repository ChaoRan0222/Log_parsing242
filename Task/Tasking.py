...
patterns = {
    ...
    'Code Commit ID / 代码提交ID': r'\*?\s*Code\s+Commit\s+ID\s*/?\s*代码提交ID[ \t]*:[ \t]*((?![ \t\r\n])[^\r\n]*)',
...
# 保存 CSV 文件
df_latest.to_csv('t1e_demestic_202401-202501allmsg_utf8Tasking.csv', index=False, encoding='utf-8', date_format='%Y-%m-%d')
